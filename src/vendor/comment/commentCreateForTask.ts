...
export async function commentCreateForTask(opts: CreateArgs, context: AxiosRequestConfig) {
  ...
  const res = await client.post(`/tasks/${taskId}/comments`, comment, context);
